  ...
  return (
    <section id="about" ref={ref} className="py-10 relative overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <h2 className={`section-heading text-center transition-all duration-700 transform px-2 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          About Me
        </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div className={`order-1 lg:order-2 flex justify-center transition-all duration-700 transform ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'
            }`}
